...
class WizardPreset {
  ...
  get preset() {
    return $(
      '//android.widget.LinearLayout[@resource-id="com.myzesty:id/preset"]/android.widget.ImageView'
    );
  }
  get preset_panel() {
  ...
  get preset_intensity_slider() {
    return $('//android.widget.SeekBar[@resource-id="com.myzesty:id/seekbar"]');
  }
  get preset_intensity_slider_value() {
    return $(
      '//android.widget.TextView[@resource-id="com.myzesty:id/barProgress"]'
    );
  }
...
export default new WizardPreset();
